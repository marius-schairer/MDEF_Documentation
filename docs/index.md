...
<div style="display:flex; width: 100%; align-items: flex-start; align-content: flex-start; gap: 10px; flex-wrap:wrap;">
    <div style="border: 4px solid rgba(0, 0, 0, 0.20); display: flex; padding: 10px; flex-direction: column; align-items: flex-start; gap: 10px; width: 40%; height: 100%; object-fit: cover; background-image: url(/Users/mars/Documents/mdef-template/docs/images/Bearbeitet/PH.png)," >
    <h2>About Me</h2>
