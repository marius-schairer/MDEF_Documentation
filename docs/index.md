...
<div style="display:flex; width: 100%; align-items: flex-start; align-content: flex-start; gap: 10px; flex-wrap:wrap;">
    <div style="border: 4px solid rgba(0, 0, 0, 0.20); display: flex; padding: 10px; flex-direction: column; align-items: flex-start; gap: 10px; width: 40%;">
    <h2>About Me</h2>
    ...
    <div style="border: 4px solid rgba(0, 0, 0, 0.20); flex-direction: column; align-items: flex-start; gap: 10px;">
    <img src="../docs/images/Bearbeitet/49582562-74C2-40A3-A025-D7D4A84E97ED.jpg" alt="Italian Trulli"></img>
        <div style="display: flex; padding: 10px; flex-direction: column; align-items: flex-start; gap: 10px; width: 40%;">
        <h2>Landing</h2>
