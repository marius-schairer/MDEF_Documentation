...
<div style="display:flex; width: 100%; align-items: flex-start; align-content: flex-start; gap: 10px; flex-wrap:wrap;">
    <div style="box-shadow: 5px 5px 0px 0px #181040; display: flex; flex-direction: row; align-items: flex-start; width: 100%; height: 100%; object-fit: cover; background-color: #181040" >
        <div style="display:flex; align-content: center; justify-content:center; width: 50%">
            ...
            <h2 style="color: #CABFFF; position: absolute; width: 300px; align-items: center; justify-content: center">About Me</h2>
        </div>
...
<div style="display:flex; width: 100%; align-items: flex-start; align-content: flex-start; gap: 20px; flex-wrap:wrap;">
    ...
    <div style="display:flex; align-content: center; justify-content:center; width: 100%">
        ...
        <h2 style="color: #181040; position: absolute; width: 300px; align-items: center; justify-content: center">Landing</h2>
    </div>
    ...
    <h2 style="color: #181040; position: absolute; width: 300px; align-items: center; justify-content: center">Documenting Design</h2>
    </div>
    <div style="padding: 10px; gap: 10px;">
    ...
    <h2 style="color: #181040; position: absolute; width: 300px; align-items: center; justify-content: center">Roles of Prototyping</h2>
    </div>
    <div style="padding: 10px; gap: 10px;">
    ...
    <div style="display:flex; align-content: center; justify-content:center; width: 100%">
    <img src="images/Bearbeitet/PH.png" style="display:flex; align-content: center; opacity: 50%"></img>
    <h2 style="color: #181040; position: absolute; width: 300px; align-items: center; justify-content: center">Atlas of Week Signals</h2>
    </div>
    <div style="padding: 10px; gap: 10px;">
    ...
    <h2 style="color: #181040; position: absolute; width: 300px; align-items: center; justify-content: center">The Machine Paradox</h2>
    </div>
    <div style="padding: 10px; gap: 10px;">
    ...
    <div style="display:flex; align-content: center; justify-content:center; width: 100%">
    <img src="images/Bearbeitet/PH.png" style="display:flex; align-content: center; opacity: 50%"></img>
    <h2 style="color: #181040; position: absolute; width: 300px; align-items: center; justify-content: center">Collective Design Space</h2>
    </div>
    <div style="padding: 10px; gap: 10px;">
    ...
    <div style="display:flex; align-content: center; justify-content:center; width: 100%">
    <img src="images/Bearbeitet/PH.png" style="display:flex; align-content: center; opacity: 50%"></img>
    <h2 style="color: #181040; position: absolute; width: 300px; align-items: center; justify-content: center">Living With Your Own Ideas</h2>
    </div>
    <div style="padding: 10px; gap: 10px;">
    ...
    <h2 style="color: #181040; position: absolute; width: 300px; align-items: center; justify-content: center">Bio Zero</h2>
    </div>
    <div style="padding: 10px; gap: 10px;">
    ...
    <h2 style="color: #181040; position: relative; width: 300px; align-items: center; justify-content: center">Agri Zero</h2>
    </div>
    <div style="padding: 10px; gap: 10px;">
    ...
    <h2 style="color: #181040; position: absolute; width: 300px; align-items: center; justify-content: center">GMO</h2>
    </div>
    <div style="padding: 10px; gap: 10px;">
